...
Hinweis für Datenbereitsteller: 
In den DCAT-AP.de Metadaten ist bei Nutzung der „Datenlizenz Deutschland – Namensnennung – Version 2.0" die Lizenz-URI „http://www.dcat-ap.de/def/licenses/dl-by-de/2.0" zu verwenden (einzusehen auf der Liste der Lizenzen unter: https://www.dcat-ap.de/def/licenses/). Wird die Lizenz in einem anderen Metadatenschema verwendet, kann abweichend auch der Lizenzcode "dl-by-de/2.0" (einzusehen auf der Liste der Lizenzen unter: https://www.dcat-ap.de/def/licenses/) verwendet werden.
